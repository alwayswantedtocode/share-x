...
//   const ulStyle = `h-max w-[100%] absolute top-[4.4rem] border-[1px] rounded-[6px] border-[#d0c8c8] bg-[#f2f2f2] py-[3px] shadow-md ${props.dropdownClass}`;
...
//   const getValue = () => {
//     return props.value ? props.value : "Select..."; // Display the label of the selected option
//   };
